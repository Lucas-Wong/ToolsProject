...
class ViedeoCrawler():
    def __init__(self):
        self.url = ""
        self.down_path = r"D:\CodeWorkspace\python\GeneralTools"
        self.final_path = r"D:\CodeWorkspace\python\GeneralTools"
        try:
    ...
    def run(self):
        ...
        ip_list = Get_Proxies.Get_proxies.get_ip_list('http://www.xicidaili.com/nn/', self.headers)
        proxies = Get_Proxies.Get_proxies.get_random_ip(ip_list)
