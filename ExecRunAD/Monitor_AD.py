...
class monitor_ad(object):
    ...
    def main(self):
        job_id = Global.get_job_id_list()
        dones = Global.get_job_done()
        job_total_count = Global.get_job_total_count()
        ...
        dones_id = None
        url = Global.get_master_1_url()

        logger.info(job_id)
        logger.info(dones)
        logger.info(job_total_count)
        logger.info(url)
