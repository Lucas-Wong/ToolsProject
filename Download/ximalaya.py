...
-----------------------------------------------------
    ...
    Description:      
-----------------------------------------------------
    Change Activity:  2018-11-28 15:34
    Description:      
----------------------------------------------------
"""
import re
...
class XimaLaya(object):
    ...
    def getHtml(self, pinyin):
        url = 'https://www.ximalaya.com/' + pinyin
        print("访问的网站是： " + url)
    ...
    def getAlbumId(self, html):
        ...
        with open('D:\\Lucas\\2-Document\\2-Personal\\XiMaLaya\\' + str('albumIdAll.txt'), 'a', encoding='utf-8') as f:
            for x in albumIdAll:
                f.write(str(x))
        myList = []
        url3 = []
        for i in (albumIdAll[:1]):
            ...
            with open('D:\\Lucas\\2-Document\\2-Personal\\XiMaLaya\\' + str('hhh.txt'), 'a', encoding='utf-8') as f:
    ...
    def getTitle(self, html):
        ...
        with open('D:\\Lucas\\2-Document\\2-Personal\\XiMaLaya\\' + str('albumId_Name.txt'), 'a', encoding='utf-8') as f:
            f.write(str(t))
        return t
    ...
    def downLoad(self, url, title):
        ...
        for i in url:
            try:
                urllib.request.urlretrieve(i, 'D:\\Lucas\\2-Document\\2-Personal\\XiMaLaya\\'+str(title[n]+'.m4a'))
